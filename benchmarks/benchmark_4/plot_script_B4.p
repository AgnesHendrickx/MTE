...
plot loc.'measurements_line.ascii' u 0:($7-$4) w lp ls 3 t '(Bx_{analytical} - Bx_{computed})',\
     loc.'measurements_line.ascii' u 0:($8-$5) w lp ls 4 t '(By_{analytical} - By_{computed})',\
     loc.'measurements_line.ascii' u 0:($9-$6) w lp ls 5 t '(Bz_{analytical} - Bz_{computed})'  
