...
set autoscale xy
set format y "%.0e"
plot 'measurements_line.ascii' u 3:($6*1e7) w lp ls 1 t 'computed' ,\
'measurements_line.ascii' u 3:9 w lp ls 2 t 'analytical' 
...
set autoscale xy
set format y
plot 'measurements_line_zoom.ascii' u 3:($6*1e7) w lp ls 1 t 'computed' ,\
'measurements_line_zoom.ascii' u 3:9 w lp  ls 2 t 'analytical' 
...
plot 'measurements_line.ascii' u 3:(($9*1e-1)-($6*1e6)) w lp ls 3 t '(Bz_{analytical} - Bz_{computed})' 
...
plot 'measurements_line_zoom.ascii' u 3:(($9*1e-1)-($6*1e6)) w lp ls 3 t '(Bz_{analytical} - Bz_{computed})' 
