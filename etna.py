...
# sDEM: size of DEM cuts (cuts were made with path kept ~ in the middle) see docstrings set_measurement_parameters for more info.
# site: 1-6.
# path: the number allocated to each path on the sites (for 1-5: 3 paths, site 6: 1 path).
# ho: for site 1-4 there are 2, ho = 1 (1 meter) and ho = 2 (1.8 meter), for site 6 there is only ho = 1 (1 meter).
#     for site 5 there are 4, ho = 1-4 (0.25,0.75,1.25,1.75 respectively).
