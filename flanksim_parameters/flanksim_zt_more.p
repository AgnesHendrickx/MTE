...
###########################################
###########################################
set output 'flanksimIn_mp_zt_180.png'
set autoscale xy
set ytics autofreq
set ytics nomirror
set xrange[100:150]
...
set output 'flanksimIc_mp_zt_180.png'
set multiplot layout 2,2
...
set output 'flanksimDc_mp_zt_180.png'
set multiplot layout 2,2
set ylabel font "times,12" 'declination [{/Symbol \260}]'
set yrange[-2:9]
set ytics -2,2
...
unset multiplot
###########################################
set terminal pngcairo enhanced size 4800,2400
set output 'flanksim_mp_zt_large.png'
set autoscale xy
set ytics autofreq
set ytics nomirror
set xrange[100:150]
...
unset multiplot
###########################################
set output 'flanksim_comp_mp_zt_180.png'
set xlabel font "times,14" 'index observation point'
set autoscale xy
set ytics autofreq
set ytics nomirror
...
plot (26850.3e-3) w l ls 1 t "IGRF x" axis x1y1,\
     ...
     loc7 u 0:($2*1e6) w lp ls 5 t "South flank" axis x1y1,\
     loc8 u 0:($2*1e6) w lp ls 4 t "West flank" axis x1y1,\
     loc50 u 0:($2*1e6) w lp ls 30 t "North flank 180" axis x1y1,\
     loc60 u 0:($2*1e6) w lp ls 60 t "East flank 180" axis x1y1,\
     loc70 u 0:($2*1e6) w lp ls 50 t "South flank 180" axis x1y1,\
     loc80 u 0:($2*1e6) w lp ls 40 t "West flank 180" axis x1y1
...
plot (1561.2e-3) w l ls 1 t "IGRF y" axis x1y1,\
     ...
     loc7 u 0:($3*1e6) w lp ls 5 t "South flank" axis x1y1,\
     loc8 u 0:($3*1e6) w lp ls 4 t "West flank" axis x1y1,\
     loc50 u 0:($3*1e6) w lp ls 30 t "North flank 180" axis x1y1,\
     loc60 u 0:($3*1e6) w lp ls 60 t "East flank 180" axis x1y1,\
     loc70 u 0:($3*1e6) w lp ls 50 t "South flank 180" axis x1y1,\
     loc80 u 0:($3*1e6) w lp ls 40 t "West flank 180" axis x1y1
...
plot (36305.7e-3) w l ls 1 t "IGRF z" axis x1y1,\
     ...
     loc7 u 0:($4*1e6) w lp ls 5 t "South flank" axis x1y1,\
     loc8 u 0:($4*1e6) w lp ls 4 t "West flank" axis x1y1,\
     loc50 u 0:($4*1e6) w lp ls 30 t "North flank 180" axis x1y1,\
     loc60 u 0:($4*1e6) w lp ls 60 t "East flank 180" axis x1y1,\
     loc70 u 0:($4*1e6) w lp ls 50 t "South flank 180" axis x1y1,\
     loc80 u 0:($4*1e6) w lp ls 40 t "West flank 180" axis x1y1
