...
loc600 = './south/extest/50_50_20_zt/measurements_line_zerotopo.ascii'
...
set style line 70 pt 7 lw 2 lc "dark-red"
set style line 40 pt 6 lw 2 lc "gold"
...
set output 'extest_comp_mp_testing.png'
#unset title
set xrange[0:46]
set xlabel font "courier,14" 'index'
...
plot loc1 u 0:($3-1) w l ls 2 t "surface" axis x1y2,\
     ...
     loc60 u 0:($5*1e6) w lp ls 70 t "fb - zt, 50x50x20" axis x1y1,\
     loc8 u 0:($5*1e6) w lp ls 9 t "250x250x20" axis x1y1,\
     loc15 u 0:($5*1e6) w lp ls 40 t "fb - zt, 250x250x20" axis x1y1,\
...
plot loc1 u 0:($3-1) w l ls 1 t "surface" axis x1y2,\
     ...
     loc60 u 0:($4*1e6) w lp ls 70 t "fb - zt, 50x50x20" axis x1y1,\
     loc8 u 0:($4*1e6) w lp ls 9 t "250x250x20" axis x1y1,\
     loc15 u 0:($4*1e6) w lp ls 40 t "fb - zt, 250x250x20" axis x1y

#set output 'extest_compbz.png'
set ylabel font "courier,14" 'Bz_a (Down) ({/Symbol m}T)'
plot loc1 u 0:($3-1) w l ls 1 t "surface" axis x1y2,\
     loc6 u 0:(-$6*1e6) w lp ls 7 t "50x50x20" axis x1y1,\
     loc60 u 0:(-$6*1e6) w lp ls 70 t "fb - zt, 50x50x20" axis x1y1,\
     loc8 u 0:(-$6*1e6) w lp ls 9 t "250x250x20" axis x1y1,\
     loc15 u 0:(-$6*1e6) w lp ls 40 t "fb - zt, 250x250x20" axis x1y1
...
plot loc1 u 0:($3-1) w l ls 1 t "surface" axis x1y2,\
     loc6 u 0:($5*1e6) w lp ls 7 t "50x50x20" axis x1y1,\
     loc60 u 0:($5*1e6) w lp ls 70 t "50x50x20_zt" axis x1y1,\
...
plot loc1 u 0:($3-1) w l ls 1 t "surface" axis x1y2,\
     loc6 u 0:($4*1e6) w lp ls 7 t "50x50x20" axis x1y1,\
     loc60 u 0:($4*1e6) w lp ls 70 t "50x50x20_zt" axis x1y1,\
     ...
     loc8 u 0:($4*1e6) w lp ls 9 t "250x250x20" axis x1y1,\
     loc15 u 0:($4*1e6) w lp ls 40 t "fb - zt, 250x250x20" axis x1y1,\
...
plot loc1 u 0:($3-1) w l ls 1 t "surface" axis x1y2,\
     loc6 u 0:(-$6*1e6) w lp ls 7 t "50x50x20" axis x1y1,\
     loc60 u 0:(-$6*1e6) w lp ls 70 t "50x50x20_zt" axis x1y1,\
