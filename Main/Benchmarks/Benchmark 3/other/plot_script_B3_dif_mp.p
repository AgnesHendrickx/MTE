...
#####################################
set output 'B3sphere_dif_mp_splitcase.png'
...
plot loc.'0_25_above/measurements_spiral.ascii' u 0:(($10*1e-7-$7)*1e6) w p ls 2 t '25 cm & 3 el/m' ,\
     loc.'0_25_above/measurements_spiral.ascii' u 0:(($11*1e-7-$8)*1e6) w p ls 3 t '25 cm & 3 el/m' ,\
     loc.'0_25_above/measurements_spiral.ascii' u 0:(($12*1e-7-$9)*1e6) w p ls 4 t '25 cm & 3 el/m'
set title font "courier,14" '50 cm & 3 el/m' 
plot loc.'0_5_above/measurements_spiral.ascii' u 0:(($10*1e-7-$7)*1e6) w p ls 2 t '50 cm & 3 el/m',\
     loc.'0_5_above/measurements_spiral.ascii' u 0:(($11*1e-7-$8)*1e6) w p ls 3 t '50 cm & 3 el/m',\
     loc.'0_5_above/measurements_spiral.ascii' u 0:(($12*1e-7-$9)*1e6) w p ls 4 t '50 cm & 3 el/m'
set title font "courier,14" '50 cm & 6 el/m' 
plot loc.'0_5_2_above/measurements_spiral.ascii' u 0:(($10*1e-7-$7)*1e6) w p ls 2 t '50 cm & 6 el/m',\
     loc.'0_5_2_above/measurements_spiral.ascii' u 0:(($11*1e-7-$8)*1e6) w p ls 3 t '50 cm & 6 el/m',\
     loc.'0_5_2_above/measurements_spiral.ascii' u 0:(($12*1e-7-$9)*1e6) w p ls 4 t '50 cm & 6 el/m'
unset multiplot
##################################
set output 'B3sphere_dif_mp.png'
set multiplot layout 1,3
#set title font "courier,16"  'sphere benchmark, fibonacci spiral' 
set xlabel font "courier,14" 'point ID'
