...
| A spatial problem, where ``P`` lies on the facet plane, is mitigated by introducing a small (:math:`\epsilon=1e^{-20}`) offset as the 'distance' from the face for computations :cite:`BLAKELY`.
