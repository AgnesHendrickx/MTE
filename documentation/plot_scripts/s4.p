...
loc1 = '/home/agnes/MTE/fieldstone_138_copy/results_5m_site4_path1_sdem2_ho1/measurements_path_plotfile.ascii'
loc2 = '/home/agnes/MTE/fieldstone_138_copy/results_5m_site4_path1_sdem2_ho2/measurements_path_plotfile.ascii'
loc3 = '/home/agnes/MTE/fieldstone_138_copy/results_5m_site4_path2_sdem2_ho1/measurements_path_plotfile.ascii'
loc4 = '/home/agnes/MTE/fieldstone_138_copy/results_5m_site4_path2_sdem2_ho2/measurements_path_plotfile.ascii'
loc5 = '/home/agnes/MTE/fieldstone_138_copy/results_5m_site4_path3_sdem2_ho1/measurements_path_plotfile.ascii'
loc6 = '/home/agnes/MTE/fieldstone_138_copy/results_5m_site4_path3_sdem2_ho2/measurements_path_plotfile.ascii'
...
set style line 13 lw 2 dt (50,8,20,8) lc "grey30" 
...
plot loc5 u 4:($1*1e6) w l ls 1 t "IGRF int" axis x1y1,\
     ...
     loc6 u 4:($9) w l ls 13 t "field topography -h:180 " axis x1y2,\
...
set output 's4p3_int_shift.png'
set key top left font "courier,14"
set ylabel font "courier,14" 'intensity ({/Symbol m}T)'
sh=5

plot loc5 u 4:($1*1e6) w l ls 1 t "IGRF int" axis x1y1,\
     loc5 u ($4+sh):($5-1) w l ls 2 t "surface 5m DEM" axis x1y2,\
     loc5 u 4:9 w l ls 3 t "field topography -h:100 " axis x1y2,\
     loc6 u 4:($9) w l ls 13 t "field topography -h:180 " axis x1y2,\
     loc5 u ($4+sh):($6*1e6) w lp ls 5 t "5m 300 DEM + IGRF -h:100" axis x1y1,\
     loc6 u ($4+sh):($6*1e6) w lp ls 15 t "5m 300 DEM + IGRF -h:180" axis x1y1,\
     loc5 u 4:10 w lp ls 4 t "field measurements -h:100" axis x1y1,\
     loc6 u 4:10 w lp ls 14 t "field measurements -h:180" axis x1y1

set output 's4p3_ic_shift.png'
set key top left font "courier,14"
set ylabel font "courier,14" 'inclination ({/Symbol \260})'
plot loc5 u 4:2 w l ls 1 t "IGRF inc" axis x1y1,\
     loc5 u ($4+sh):($5-1) w l ls 2 t "surface 5m DEM" axis x1y2,\
     loc5 u 4:9 w l ls 3 t "field topography -h:100 " axis x1y2,\
     loc6 u 4:($9) w l ls 13 t "field topography -h:180 " axis x1y2,\
     loc5 u ($4+sh):7 w lp ls 5 t "5m 300 DEM + IGRF -h:100" axis x1y1,\
     loc6 u ($4+sh):7 w lp ls 15 t "5m 300 DEM + IGRF -h:180" axis x1y1,\
     loc5 u 4:11 w lp ls 4 t "field measurements -h:100" axis x1y1,\
     loc6 u 4:11 w lp ls 14 t "field measurements -h:180" axis x1y1

set output 's4p3_dc_shift.png'
set key top left font "courier,14"
set yrange[-7:6]
set ylabel font "courier,14" 'declination ({/Symbol \260})'
plot loc5 u 4:3 w l ls 1 t "IGRF dec" axis x1y1,\
     ...
     loc5 u 4:($9) w l ls 3 t "field topography -h:100 " axis x1y2,\
     loc6 u 4:($9) w l ls 13 t "field topography -h:180 " axis x1y2,\
     loc5 u ($4+sh):8 w lp ls 5 t "5m 300 DEM + IGRF -h:100" axis x1y1,\
     loc6 u ($4+sh):8 w lp ls 15 t "5m 300 DEM + IGRF -h:180" axis x1y1,\
     loc5 u 4:12 w lp ls 4 t "field measurements -h:100" axis x1y1,\
     loc6 u 4:12 w lp ls 14 t "field measurements -h:180" axis x1y1
####################################################
set terminal pngcairo size 1200,1800
set output 's4p3_mp_shift.png'
set yrange[*:*]
set multiplot layout 3,1
#unset title
