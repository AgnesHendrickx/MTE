...
def topography(x,y,A,llambda,cos_dir,sin_dir,slopex,slopey):
    ...
    :param slopex: the arctan of the angle (in rad) of the surface that defines the slope in x direction for each respective side.
    :type slopex: scalar(float)
    :param slopey: the arctan of the angle (in rad) of the surface that defines the slope in y direction for each respective side. 
