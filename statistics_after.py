...
def compute_statistics(file_path, output_csv_path): # Designed for plotfile.ascii
    ...
    for col, col_field, igrf_col, name in [(intensity_siB0, intensity_field, igrf_intensity, 'Intensity'),
        ...
        stats.append([name + ' Mean from IGRF',
                      '',
                      np.nanmean(np.abs(col - igrf_col)),
                      np.nanmean(np.abs(col_field - igrf_col)),
                      '',
                      ''])
...
file_path = './path_results/results_5m_site6_path1_sdem4_ho1_fb_zt/measurements_path_plotfile.ascii'  # Replace with your file path
output_csv_path = 'output_statistics_s6_p1.csv'  # Replace with your desired output path
file_path = './path_results/results_5m_site1_path1_sdem2_ho1_fb_zt/measurements_path_plotfile.ascii'  # Replace with your file path
